...
type BackupRunner interface {
	Backup(ctx context.Context, appName string, all bool, services []string) (runner.Result, error)
	BackupWithRetention(ctx context.Context, appName string, all bool, services []string, retention backup.PruneOptions) (runner.Result, error)
}
